...
test('raw anchors produce same-origin durable children with exact byte locators and parent lineage',async()=>{
 const html='<html><head><link rel="canonical" href="/not-a-link"></head><body><a href="/child">🧠</a><a href="/private">private</a><a href="https://other.example/out">out</a><a href="/logout">action</a><script>"<a href=/fake>"</script></body></html>';
