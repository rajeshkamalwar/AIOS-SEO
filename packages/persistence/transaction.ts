...
export type ServiceRole = 'aios_runtime'|'aios_scheduler'|'aios_evaluator'|'aios_operator'|'aios_http_supervisor' | 'aios_render_supervisor' | 'aios_render_acceptor' | 'aios_http_acceptor';
