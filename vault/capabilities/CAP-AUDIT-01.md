---
id: "CAP-AUDIT-01"
title: "Sensor and connector reliability"
domain: "AUDIT"
maturity: "DEFINED"
...
implementation: ["packages/policy/index.ts", "packages/jobs/index.ts", "spec/quality-gates.json"]
tests: ["tests/policy.test.ts", "tests/jobs.test.ts"]
...
scope: "Configured sensor/reliability checks and health gate with supplied signals."
baseline: "2b6d527"
...
# CAP-AUDIT-01 — Sensor and connector reliability

Canonical responsibility: [CAP-AUDIT-01](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.

Full capability maturity: **DEFINED**, completion: **INCOMPLETE**. Local evidence scope: `foundation_only` / `TESTED`.

Configured sensor/reliability checks and health gate with supplied signals.

Implementation: [index.ts](../../packages/policy/index.ts), [index.ts](../../packages/jobs/index.ts), [quality-gates.json](../../spec/quality-gates.json)

Tests: [policy.test.ts](../../tests/policy.test.ts), [jobs.test.ts](../../tests/jobs.test.ts)
...
Remaining: No full automatic sensor/connector telemetry collection, coverage diagnosis and independently evaluated health monitoring.
