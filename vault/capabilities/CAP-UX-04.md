...
reports: ["reports/PUBLICATION-AND-READ-SCOPE-HARDENING.md", "reports/API-CONTRACT-CORRECTIONS.md", "docs/40-POST-M5-INTEGRATION-REALITY-REVIEW.md", "docs/41-NEXT-PHASE-READINESS-PLAN.md", "docs/reports/N1-IMPLEMENTATION.md", "reports/POST-VAULT-READONLY-CORRECTIONS.md"]
