...
gaps: ["GAP-DOM-PAGE"]
scope: "Source-located title and named-meta extraction."
baseline: "2b6d527"
...
# CAP-PAGE-02 — Description usefulness

Canonical responsibility: [CAP-PAGE-02](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.

Full capability maturity: **DEFINED**, completion: **INCOMPLETE**. Local evidence scope: `foundation_only` / `TESTED`.

Source-located title and named-meta extraction.
...
Remaining: No offering/intent-conditioned title or description usefulness diagnosis; extraction does not establish SEO quality.
