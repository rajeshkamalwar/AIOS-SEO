---
id: "CAP-URL-05"
title: "Canonical target eligibility"
domain: "URL"
maturity: "DEFINED"
...
# CAP-URL-05 — Canonical target eligibility

Canonical responsibility: [CAP-URL-05](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.
