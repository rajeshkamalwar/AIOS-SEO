---
id: "CAP-JS-05"
title: "Dynamic metadata consistency"
domain: "JS"
maturity: "DEFINED"
...
# CAP-JS-05 — Dynamic metadata consistency

Canonical responsibility: [CAP-JS-05](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.
