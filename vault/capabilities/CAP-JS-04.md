---
id: "CAP-JS-04"
title: "Client navigation discoverability"
domain: "JS"
maturity: "DEFINED"
...
scope: "Static resolved anchor extraction and synthetic durable link expansion."
baseline: "2b6d527"
...
# CAP-JS-04 — Client navigation discoverability

Canonical responsibility: [CAP-JS-04](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.

Full capability maturity: **DEFINED**, completion: **INCOMPLETE**. Local evidence scope: `foundation_only` / `TESTED`.

Static resolved anchor extraction and synthetic durable link expansion.
...
Remaining: No client-route/direct-load discoverability comparison or evaluated rendered-route map.
