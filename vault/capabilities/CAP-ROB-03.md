...
implementation: ["packages/perception/collector.ts", "packages/persistence/index.ts"]
tests: ["tests/collector.test.ts", "tests/http-evidence.test.ts"]
...
scope: "Allowed x-robots-tag header retention in bounded HTTP receipts."
baseline: "2b6d527"
...
# CAP-ROB-03 — X-Robots-Tag analysis

Canonical responsibility: [CAP-ROB-03](../../docs/14-CAPABILITY-TAXONOMY.md) (exact row ID); inherited [contract](../../docs/15-CAPABILITY-CONTRACT.md) and [archetype applicability](../../docs/18-BUSINESS-ARCHETYPE-MATRIX.md). Definition is deliberately not copied.

Full capability maturity: **DEFINED**, completion: **INCOMPLETE**. Local evidence scope: `foundation_only` / `TESTED`.

Allowed x-robots-tag header retention in bounded HTTP receipts.

Implementation: [collector.ts](../../packages/perception/collector.ts), [index.ts](../../packages/persistence/index.ts)

Tests: [collector.test.ts](../../tests/collector.test.ts), [http-evidence.test.ts](../../tests/http-evidence.test.ts)
...
Remaining: No X-Robots-Tag grammar/agent interpretation, inheritance assessment or non-HTML directive capability.
