---
id: "GAP-DOM-TER"
title: "Territory and opportunity strategy canonical capability delivery"
status: "OPEN"
severity: "HIGH"
scope: "Full domain capability delivery, not a blocker for unrelated dependency-ready work"
owner_role: "Territory and opportunity strategy domain owner and independent evaluation"
...
# GAP-DOM-TER — Territory and opportunity strategy

Canonical responsibilities: [CAP-TER-01](../capabilities/CAP-TER-01.md), [CAP-TER-02](../capabilities/CAP-TER-02.md), [CAP-TER-03](../capabilities/CAP-TER-03.md), [CAP-TER-04](../capabilities/CAP-TER-04.md), [CAP-TER-05](../capabilities/CAP-TER-05.md).
