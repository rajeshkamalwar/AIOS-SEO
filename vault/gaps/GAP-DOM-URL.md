---
id: "GAP-DOM-URL"
title: "Identity, canonicalization and duplication canonical capability delivery"
status: "OPEN"
severity: "HIGH"
affected_capabilities: ["CAP-URL-01", "CAP-URL-02", "CAP-URL-03", "CAP-URL-04", "CAP-URL-05"]
scope: "Full domain capability delivery, not a blocker for unrelated dependency-ready work"
owner_role: "Identity, canonicalization and duplication domain owner and independent evaluation"
...
implementation: ["packages/jobs/frontier.ts", "packages/perception/dom.ts", "packages/perception/url.ts", "packages/persistence/migrations/004-perception.sql"]
tests: ["tests/collector.test.ts", "tests/dom.test.ts", "tests/frontier-links.test.ts", "tests/perception.test.ts"]
...
# GAP-DOM-URL — Identity, canonicalization and duplication

Canonical responsibilities: [CAP-URL-01](../capabilities/CAP-URL-01.md), [CAP-URL-02](../capabilities/CAP-URL-02.md), [CAP-URL-03](../capabilities/CAP-URL-03.md), [CAP-URL-04](../capabilities/CAP-URL-04.md), [CAP-URL-05](../capabilities/CAP-URL-05.md).
