---
id: "GAP-DOM-MEM"
title: "Temporal memory and graph integrity canonical capability delivery"
status: "OPEN"
severity: "HIGH"
affected_capabilities: ["CAP-MEM-01", "CAP-MEM-02", "CAP-MEM-03", "CAP-MEM-04"]
scope: "Full domain capability delivery, not a blocker for unrelated dependency-ready work"
owner_role: "Temporal memory and graph integrity domain owner and independent evaluation"
...
implementation: ["packages/api/index.ts", "packages/evidence/index.ts", "packages/persistence/index.ts", "packages/persistence/migrations/001-evidence-ledger.sql", "packages/persistence/migrations/003-readonly-publication.sql", "packages/persistence/transaction.ts", "packages/policy/deletion.ts", "packages/policy/input-eligibility.ts", "packages/runtime/index.ts", "packages/understanding/index.ts"]
tests: ["tests/api.test.ts", "tests/blob.test.ts", "tests/foundation.test.ts", "tests/input-eligibility.test.ts", "tests/jobs.test.ts", "tests/runtime.test.ts", "tests/understanding.test.ts"]
...
# GAP-DOM-MEM — Temporal memory and graph integrity

Canonical responsibilities: [CAP-MEM-01](../capabilities/CAP-MEM-01.md), [CAP-MEM-02](../capabilities/CAP-MEM-02.md), [CAP-MEM-03](../capabilities/CAP-MEM-03.md), [CAP-MEM-04](../capabilities/CAP-MEM-04.md).
