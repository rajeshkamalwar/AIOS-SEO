---
id: "GAP-DOM-AUDIT"
title: "Brain reliability and self-audit canonical capability delivery"
status: "OPEN"
severity: "HIGH"
affected_capabilities: ["CAP-AUDIT-01", "CAP-AUDIT-02", "CAP-AUDIT-03", "CAP-AUDIT-04", "CAP-AUDIT-05"]
scope: "Full domain capability delivery, not a blocker for unrelated dependency-ready work"
owner_role: "Brain reliability and self-audit domain owner and independent evaluation"
...
implementation: ["packages/jobs/http-lane.ts", "packages/jobs/index.ts", "packages/policy/index.ts", "packages/policy/input-eligibility.ts", "packages/runtime/index.ts", "packages/skills/index.ts", "spec/quality-gates.json"]
tests: ["tests/http-lane.test.ts", "tests/input-eligibility.test.ts", "tests/jobs.test.ts", "tests/policy.test.ts", "tests/runtime.test.ts"]
...
# GAP-DOM-AUDIT — Brain reliability and self-audit

Canonical responsibilities: [CAP-AUDIT-01](../capabilities/CAP-AUDIT-01.md), [CAP-AUDIT-02](../capabilities/CAP-AUDIT-02.md), [CAP-AUDIT-03](../capabilities/CAP-AUDIT-03.md), [CAP-AUDIT-04](../capabilities/CAP-AUDIT-04.md), [CAP-AUDIT-05](../capabilities/CAP-AUDIT-05.md).
