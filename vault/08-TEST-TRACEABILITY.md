...
| [GOVERNED-HTTP-BOOTSTRAP](milestones/GOVERNED-HTTP-BOOTSTRAP.md) | [http-bootstrap-job.ts](../packages/jobs/http-bootstrap-job.ts), [index.ts](../packages/jobs/index.ts), [isolated-http-fixture-supervisor.ts](../packages/jobs/isolated-http-fixture-supervisor.ts), [http-lane.ts](../packages/jobs/http-lane.ts), [http-bootstrap.ts](../packages/skills/http-bootstrap.ts), [021-http-bootstrap-job.sql](../packages/persistence/migrations/021-http-bootstrap-job.sql) | [http-bootstrap.test.ts](../tests/http-bootstrap.test.ts), [http-isolated.test.ts](../tests/http-isolated.test.ts), [http-fixture-broker.test.ts](../tests/http-fixture-broker.test.ts), [http-fixture-engine.test.ts](../tests/http-fixture-engine.test.ts) | [GOVERNED-HTTP-BOOTSTRAP.md](../reports/GOVERNED-HTTP-BOOTSTRAP.md) / parent42d88b3 |
| [GOVERNED-HTTP-EVIDENCE](milestones/GOVERNED-HTTP-EVIDENCE.md) | [isolated-http-fixture-supervisor.ts](../packages/jobs/isolated-http-fixture-supervisor.ts), [http-fixture-broker.ts](../packages/perception/http-fixture-broker.ts), [http-bootstrap-acceptance.ts](../packages/jobs/http-bootstrap-acceptance.ts), [reviewed-fixtures.ts](../packages/perception/reviewed-fixtures.ts), [022-http-bootstrap-acceptance.sql](../packages/persistence/migrations/022-http-bootstrap-acceptance.sql) | [http-isolated.test.ts](../tests/http-isolated.test.ts), [http-acceptance.test.ts](../tests/http-acceptance.test.ts), [http-fixture-broker.test.ts](../tests/http-fixture-broker.test.ts), [reviewed-fixtures.test.ts](../tests/reviewed-fixtures.test.ts) | [GOVERNED-HTTP-EVIDENCE.md](../reports/GOVERNED-HTTP-EVIDENCE.md) / parentaa8e9f7 |
| [GOVERNED-ROBOTS-COMPLETION](milestones/GOVERNED-ROBOTS-COMPLETION.md) | [robots-admission.ts](../packages/perception/robots-admission.ts), [index.ts](../packages/jobs/index.ts), [http-bootstrap-projection.ts](../packages/jobs/http-bootstrap-projection.ts), [isolated-http-fixture-supervisor.ts](../packages/jobs/isolated-http-fixture-supervisor.ts), [023-http-bootstrap-projection.sql](../packages/persistence/migrations/023-http-bootstrap-projection.sql) | [robots.test.ts](../tests/robots.test.ts), [http-bootstrap-projection.test.ts](../tests/http-bootstrap-projection.test.ts) | [GOVERNED-ROBOTS-COMPLETION.md](../reports/GOVERNED-ROBOTS-COMPLETION.md) / parentf5402a1 |
| [GOVERNED-SEED-ADMISSION](milestones/GOVERNED-SEED-ADMISSION.md) | [http-bootstrap-projection.ts](../packages/jobs/http-bootstrap-projection.ts), [index.ts](../packages/jobs/index.ts), [http-bootstrap-seed.ts](../packages/jobs/http-bootstrap-seed.ts), [024-http-bootstrap-seed.sql](../packages/persistence/migrations/024-http-bootstrap-seed.sql) | [http-bootstrap-projection.test.ts](../tests/http-bootstrap-projection.test.ts), [http-bootstrap-seed.test.ts](../tests/http-bootstrap-seed.test.ts) | [GOVERNED-SEED-ADMISSION.md](../reports/GOVERNED-SEED-ADMISSION.md) / parent2ec8bc6 |
...
- [http-acceptance.test.ts](../tests/http-acceptance.test.ts)
- [http-bootstrap-projection.test.ts](../tests/http-bootstrap-projection.test.ts)
- [http-bootstrap-seed.test.ts](../tests/http-bootstrap-seed.test.ts)
- [http-bootstrap.test.ts](../tests/http-bootstrap.test.ts)
...
- [render-acceptance.test.ts](../tests/render-acceptance.test.ts)
...
- [render-privacy.test.ts](../tests/render-privacy.test.ts)
