...
M1 adds capture.schema.json for its internal fixture-capture metadata; raw bytes are a separate bounded binary argument. camelCase fields belong to this internal library boundary; persisted domain records retain their canonical snake_case fields.
